...
public class ModifyUserWindow extends javax.swing.JFrame {
    ...
    public ModifyUserWindow(UserManager userManager, JFrame parentWindow) {
        ...
        // Mostrar usuarios disponibles en el título
        mostrarUsuariosDisponibles();
    }

    /**
     * Muestra los usuarios Admin/Técnico disponibles en el título
     */
    private void mostrarUsuariosDisponibles() {
        ...
        try {
            ...
            for (User u : userManager.getAllUsers()) {
                if (u != null && ("ADMIN".equalsIgnoreCase(u.getRol()) || "TECNICO".equalsIgnoreCase(u.getRol()))) {
                    if (count > 0)
                        sb.append(", ");
            ...
            if (count > 0) {
                setTitle("Modificar Usuario - " + sb.toString());
            }
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/utils/LOGO1.png"))); // NOI18N
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (nombre.isEmpty() || apellido.isEmpty() || dni.length() != 8 ||
            ...
            JOptionPane.showMessageDialog(this,
                    "Todos los campos requeridos deben estar completos y en formato correcto.");
            return;
        }
        u.setNombre(nombre);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnBuscarActionPerformed
        ...
        User u = userManager.findUserByUsuario(username);
        if (u != null) {
            // Solo permitir modificar Admin/Técnico, no clientes
            if ("CLIENTE".equalsIgnoreCase(u.getRol())) {
                JOptionPane.showMessageDialog(this,
                        "No se pueden modificar usuarios con rol CLIENTE desde esta ventana.");
                return;
            }
            ...
            JOptionPane.showMessageDialog(this, "Usuario encontrado: " + u.getNombre() + " " + u.getApellido());
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifyUserWindow.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
