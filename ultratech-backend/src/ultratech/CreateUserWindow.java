...
public class CreateUserWindow extends javax.swing.JFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(20, 20, 20)
                                .addComponent(txttoptech, javax.swing.GroupLayout.PREFERRED_SIZE, 316, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(78, 78, 78)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnGuardarActionPerformed
        ...
        // DNI: 8 dígitos (persona) u 11 dígitos (RUC)
        if (dni.length() != 8 && dni.length() != 11) {
            JOptionPane.showMessageDialog(this, "El DNI debe tener 8 dígitos o RUC 11 dígitos.");
            return;
        }
        if (!dni.matches("\\d+")) {
            JOptionPane.showMessageDialog(this, "El DNI/RUC solo debe contener números.");
            return;
        }
        if (usuario.isEmpty()) {
        ...
        // Contraseña: mínimo 4, máximo 20 caracteres
        if (pass.length() < 4 || pass.length() > 20) {
            JOptionPane.showMessageDialog(this, "La contraseña debe tener entre 4 y 20 caracteres.");
            return;
        }
        ...
        // Ajuste de rol - Solo ADMIN o TECNICO permitidos
        String rolFinal;
        if (rol.equalsIgnoreCase("ADMINISTRADOR")) {
            ...
            JOptionPane.showMessageDialog(this, "Debe seleccionar un rol válido (ADMINISTRADOR o TECNICO).");
            return;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateUserWindow.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
